...
<head>
    ...
    <title><?php echo $settings_r['site_title'] ?> - Package Details</title>
                    ...
                    <div class="card-body">
                        <?php
                            ...
                            if(!$settings_r['shutdown']){
                                ...
                                echo<<<book
                                    <button onclick='checkLoginToBook($login,$package_data[id])' class='btn w-100 text-white custom-bg shadow-none mb-1'>Book Now</button>
                                book;
                            }
