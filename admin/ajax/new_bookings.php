<?php
    ...
    if(isset($_POST['get_bookings']))
    {
        ...
        while($data = mysqli_fetch_assoc($res))
        {
            ...
            $arrival_date = date("d-m-Y",strtotime($data['arrival_date']));
            $leaving_date = date("d-m-Y",strtotime($data['leaving_date']));
            ...
            $table_data .="
                <tr>
                    ...
                    <td>
                        <b>arrival_date:</b> $arrival_date
                        <br>
                        <b>leaving_date:</b> $leaving_date
                        <br>
                    ...
                    <td>
                        <button type='button' onclick='assign_package($data[booking_id])' class='btn text-white btn-sm fw-bold custom-bg shadow-none' data-bs-toggle='modal' data-bs-target='#assign-package'>
    ...
    if(isset($_POST['assign_package']))
    {
        ...
        $query = "UPDATE `booking_order` bo 
            ...
            SET bo.arrival = ?, bd.no = ?
            WHERE bo.booking_id = ?";

        $values = [1,$frm_data['no'],$frm_data['booking_id']];
