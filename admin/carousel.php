                        ...
                        <div class="row" id="carousel-data"> 
                            <div class="col-md-2 mb-3"> 
                                <div class="card bg-dark text-white"> 
                                    <img src="<?php echo CAROUSEL_IMG_PATH.'1.jpg'; ?>" class="card-img"> 
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">                                    
                                    <div class="mb-3">
                                        ...
                                        <input type="file" id="carousel_picture_inp" name="carousel_picture" accept=".jpg,.jpeg,.png,.webp" class="form-control shadow-none" required>
                                    </div>
                                </div>
