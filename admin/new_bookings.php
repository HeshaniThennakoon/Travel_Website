...
<body class="bg-light">
    ...
    <div class="modal fade" id="assign-package" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="no" class="form-control shadow-none" required>
                        </div>
